import { authByTelegram } from '@/core/auth/api/requests';
import { authStore } from '@/core/auth/store/store';
import { createAcceptInviteMutation, createInviteDetailQuery } from '@/core/invites/api/queries';
import {
...
} from '@/core/invites/lib/invite';
import { InviteStatus } from '@/core/invites/model/types';
import { WORKSPACE_ROLE_LABELS } from '@/core/workspace/model/types';
