<script lang="ts">
  ...
  import { canInviteUsers, getAllowedInviteRoles } from '@/core/invites/lib/workspace-invites';
  import { createWorkspaceBillingQuery, createWorkspaceUsersQuery } from '@/core/workspace/api/queries';
  import InviteUserModal from '@/core/workspace/components/invite-user-modal.svelte';
  import WorkspaceMemberRow from '@/core/workspace/components/workspace-member-row.svelte';
  import {
    isWorkspaceMemberFilter,
    WORKSPACE_MEMBER_FILTER_LABELS,
    WORKSPACE_MEMBER_FILTERS,
    type WorkspaceMemberFilter,
  } from '@/core/workspace/members/lib';
  import type { WorkspaceUser, WorkspaceUsersFilters } from '@/core/workspace/model/types';
  import { buildWorkspaceUsersRoute } from '@/core/workspace/routing/users-route';
  import { hasReachedMembersLimit } from '@/modules/billing/domain';
  ...
  import RelatedList from '@/shared/components/ui/related-list.svelte';
  import SearchIcon from '@/shared/icons/search-icon.svelte';
  import UserPlusIcon from '@/shared/icons/user-plus-icon.svelte';
  import UsersEmptyIcon from '@/shared/icons/users-empty-icon.svelte';
