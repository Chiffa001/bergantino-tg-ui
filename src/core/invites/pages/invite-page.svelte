<script lang="ts">
  ...
  import { useInvitePage } from '@/core/invites/hooks/use-invite-page.svelte';
  import { InviteScreenState } from '@/core/invites/lib/invite';
  import Button from '@/shared/components/ui/button.svelte';
  import ForbiddenIcon from '@/shared/icons/forbidden-icon.svelte';
  import InviteUserIcon from '@/shared/icons/invite-user-icon.svelte';
  import NotFoundIcon from '@/shared/icons/not-found-icon.svelte';
