<script lang="ts">
  ...
  import { createWorkspaceBillingQuery, createWorkspaceDetailQuery } from '@/core/workspace/api/queries';
  import { setStoredWorkspaceSlug } from '@/core/workspace/context/lib';
  import {
  ...
  import ChevronRightIcon from '@/shared/icons/chevron-right-icon.svelte';
  import InviteUserIcon from '@/shared/icons/invite-user-icon.svelte';
  import PaymentCardIcon from '@/shared/icons/payment-card-icon.svelte';
  import SettingsGearIcon from '@/shared/icons/settings-gear-icon.svelte';
  import { formatDate } from '@/shared/lib/format-date';
  import { formatFeeRate } from '@/shared/lib/format-fee-rate';
