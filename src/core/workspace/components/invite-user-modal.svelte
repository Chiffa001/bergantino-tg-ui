<script lang="ts">
  ...
  } from '@/core/invites/lib/workspace-invites';
  import { createWorkspaceInviteMutation } from '@/core/workspace/api/queries';
  import type { WorkspaceInvite, WorkspaceInviteRole } from '@/core/workspace/model/types';
  import {
  ...
  import RadioCardOption from '@/shared/components/ui/radio-card-option.svelte';
  import { copyTextToClipboard } from '@/shared/lib/copy-to-clipboard';
  import { formatInviteExpirationDays } from '@/shared/lib/invite-expiration';
