<script lang="ts">
  ...
  import CreateGroupModal from '@/components/workspaces/create-group-modal.svelte';
  import { useWorkspaceGroupsPage } from '@/hooks/use-workspace-groups-page.svelte';
              ...
              <div class="group-card__header">
                ...
                <span class={getStatusClassName(group.status)}>
                  <Typography
                    ...
                    color="currentColor"
                  >
                    {WORKSPACE_GROUP_STATUS_LABELS[group.status]}
                  </Typography>
                </span>
              </div>
